...
* I decided that the stories relating to stock management for the admin on the front end are not essential to the project, as this is the purpose of the built in admin panel. instead I wil be looking to best utilizgit add e the built in admin panel to make it as easy as possible for the admin to manage the site.
